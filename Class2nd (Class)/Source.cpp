...
#pragma region 접근 지정자
	...
	// 제한하는 지정자입니다.
	// 
	// public : 클래스 외부에서 데이터를 접근할 수 있도록 허용하는 접근 지정자입니다. 
	// 
	// protected : 클래스 내부와 자기가 상속하고 있는 클래스에서만 접근을 허용하는 접근 지정자입니다. 
	// 
	// private : 클래스 내부에서만 접근을 허용하는 접근 지정자입니다. (기본) 
#pragma endregion
...
#pragma region 클래스(Class)
	// 사용자 정의 데이터 유형으로 속성과 함수가 포함되어 있으며, 클래스를 통해 객체를 생성하여
